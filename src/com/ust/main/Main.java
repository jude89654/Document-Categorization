...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FileUtilities.copyDevLabelFile(new File("project/dev_label.txt"), new File("tempFolder/dev_label.txt"));
    ...
    public static void moveCategorizedFiles(File[] categorizedfile, ArrayList<Integer> results) {
        String folders[] = {"letter/application/", "letter/complaint/", "letter/resignation/","memorandum/","reports/"};
