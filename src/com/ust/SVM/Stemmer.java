 ...
 * 
 * Code written by: Layla Oesper Authors: Layla Oesper, Ruth Isserlin, Daniele Merico
 * 
...
/**
 * com.ust.SVM.Stemmer, implementing the Porter Stemming Algorithm
 * <p>
 * The com.ust.SVM.Stemmer class transforms a word into its root form. The input word can be provided a
...
class Stemmer {
    ...
    /**
     * Stem the word placed into the com.ust.SVM.Stemmer buffer through calls to add(). Returns true if the
