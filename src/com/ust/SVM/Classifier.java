...
public class Classifier {
    ...
    final String OUTPUT_TRAIN_FILE = "startTraining.txt";
    ...
    private void readTestClassNames(String test_class_filename) throws NumberFormatException, IOException {
        ...
        System.out.println("Found " + testClassNameMap.size() + " StartTesting instances");
        br.close();
    }
    ...
    private void readTestFiles(String testing_folder) throws NumberFormatException, IOException {
        System.out.println("Started reading StartTesting files");
        ...
        System.out.println("Finished reading StartTesting files");
    }
    ...
    private void writeTestFile() throws IOException {
        ...
        System.out.println("Finished writing StartTesting file - " + OUTPUT_TEST_FILE);
        bw.close();
    }
